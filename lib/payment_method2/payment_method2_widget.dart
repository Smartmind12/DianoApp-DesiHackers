...
import '../payment_method3/payment_method3_widget.dart';
...
class PaymentMethod2Widget extends StatefulWidget {
  const PaymentMethod2Widget({Key? key}) : super(key: key);

  @override
  _PaymentMethod2WidgetState createState() => _PaymentMethod2WidgetState();
}
              ...
              child: InkWell(
                onTap: () async {
                  await Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => PaymentMethod3Widget(),
                    ),
                  );
                },
                child: Container(
